...
#define ActiveApp_FlowFieldPathFinding
...
#ifdef ActiveApp_FlowFieldPathFinding
#include "projects/Movement/Pathfinding/FlowfieldPathfinding/App_FlowFieldPathFinding.h"
